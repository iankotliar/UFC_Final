...
3. **Exploratory Data Analysis & Historical Profitability Analysis**
    ...
    * [Notebook](code/Analysis/Exploratory/8_explore_35_42_overperformance.ipynb)
    ...
    * Interestingly, I did find a pocket of inefficiency in the betting market. Fighters whose average "balanced book" probability of winning accross the sites fell within the 35% to 45% range seemed to win 4% to 6% more often than their probabilities during the 2013 - 2020 period. Further investigation showed that the majority of this overperformance was stemming from fighters on the main card, as opposed to the preliminary card. Specifically, I found that fighters on the main card with a 37.5% - 45% fair-odds probability of winning won on average 10% more often than would be predicted by their odds. I performed binomial tests which confirmed that this overperformance was statistically significant. Betting on such fighters would have generated average annual returns of 20% from 2013 to 2020. However, the overperformance was not present during the 2008 - 2012 period, and this strategy would have lost money during these years. One potential explaination for this finding is that casual fan enthusiasm for slight favorites can distort the odds in close fights, leading to imperfect odds. This phenomenon may have not existed prior to 2012 because the sport was not nearly as popular. 
