...
3. **Exploratory Data Analysis & Historical Profitability Analysis**
   ...
   * I investigated whether betting on fighters with average probability of winning in the 37% to 43% range would have made money. This strategy made money between 2013 to the present, but generally lost money in prior years. It seems that the overperformance of underdog fighters in this range has only existed for the past several years. However, this overperformance in recent years seems too large and consistent to have been due to chance. What likely happened in these cases is that fans wanted to bet on one side of what was essentially of a 50-50 match up, leading to the imbalanced odds. 
4. **Future Work**
